...
export default function SettingsContent() {
  ...
  return (
    <div className="flex h-[calc(100svh-3.5rem)] flex-col p-4 md:p-6">
      ...
      >
        <TabsList className="inline-flex h-auto w-full shrink-0 flex-row items-center justify-start gap-1 overflow-x-auto rounded-lg bg-muted/50 p-1 md:w-52 md:flex-col md:items-stretch md:gap-1 md:overflow-visible md:self-start">
          {SETTINGS_TABS.map((item) => {
            ...
            return (
              <TabsTrigger
                ...
                value={item.value}
                className={cn(
                  'h-9 shrink-0 flex-none gap-2 px-3 py-2',
                  'md:h-10 md:w-full md:flex-none md:justify-start',
